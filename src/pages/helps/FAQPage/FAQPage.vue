    ...
    <div>
        ...
        <el-row type="flex" justify="center">
            <el-col :xs="24" :sm="18">
                ...
                <p>Different target functions are the core characteristics of this site, and there are big differences between characters, and the equipment can not be generalized at all. Therefore, this site provides a variety of equipment targets, that is, target functions. For example, you can choose the maximum expected output of Hu Tao's E skill, because Hu Tao has the characteristic of transforming HP into ATK, and you can also choose Noelles’s Q skill to maximize output because Noelle has the characteristic of DEF conversion to ATK.</p>
