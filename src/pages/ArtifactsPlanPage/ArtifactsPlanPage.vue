...
export default {
    ...
    methods: {
        ...
        handleClickApplyPreset() {
            ...
            if (count === 0) {
                this.$message({
                    message: "No presets available, please save a preset first",
                    type: "warning",
                });
                return;
            }
        ...
        saveAsPreset() {
            this.$prompt("Give a Name", "Save as Preset", {
                ...
                if (!this.checkPresetNameDuplicate(value)) {
                    this.$confirm("The name already exists, do you want to overwrite it?", "Hint", {
                        confirmButtonText: "Save",
                        cancelButtonText: "Cancel",
                    }).then(() => {
                        let preset = this.getConfigObject(true);
