<template>
    <div>
        <el-breadcrumb>
            <el-breadcrumb-item>Artifacts Statistics</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-row style="margin-bottom: 16px">
            ...
            >
                <el-card>
                    <div slot="header">
                        Substat efficiency distribution (only level 20 5-star artifacts are counted)
                    </div>
                    ...
                    <el-tag>
                        Artifacts composite score: {{ overallRating.toFixed(3) }}
                    </el-tag>
                </el-card>
            </el-col>
        </el-row>
