    ...
    <div>
        ...
        <div v-show="showSkill === 'e'">
            <common-table-fire
                :data="tuomaE.e"
            ></common-table-fire>
            <p class="single-item">Shield Damage Absortion：{{ tuomaE.shield1 }}</p>
            <p class="single-item">Maximum Shield Damage Absortion：{{ tuomaE.shield2 }}</p>
        </div>
        ...
        <div v-show="showSkill === 'q'">
            <common-table-fire
                :data="tuomaQ.q"
            ></common-table-fire>
            <p class="single-item">Ultimate Shield Damage Absortion：{{ tuomaQ.shield1 }}</p>
        </div>
