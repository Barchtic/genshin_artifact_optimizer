<template>
    <div>
        <el-alert
            title="In fact, these parameters are not so important, basically skipping can "
            :closable="false"
            type="warning"
            class="hint"
        ></el-alert>
        <div class="config-item">
            ...
            <el-alert
                title="Refers to the character + weapon's basic attack power"
                :closable="false"
                class="hint"
            ></el-alert>
        ...
        <div class="config-item">
            <h3 class="config-title">ATK</h3>
            <el-alert
                title="Can be considered to remove the attack power of the subcompix"
                :closable="false"
                class="hint"
            ></el-alert>
        ...
        <div class="config-item">
            <h3 class="config-title">Base Crit Damage</h3>
